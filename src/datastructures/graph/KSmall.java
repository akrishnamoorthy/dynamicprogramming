...
public class KSmall {
    ...
    public static void main (String[] args)
    {
       ...
       que.addFirst(1);
        ...
        val.computeIfAbsent(1, (x) -> new ArrayList<>()).add(2);
        val.computeIfAbsent(1, (x) -> new ArrayList<>()).add(3);
        val.computeIfAbsent(2, (x) -> new ArrayList<>()).add(5);

        for(Integer x : val.keySet()){
            System.out.println(x);
            System.out.println(val.get(x));
        }
